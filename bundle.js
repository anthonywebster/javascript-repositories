...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = new _vue2.default({
		...
		mounted: function mounted() {
			...
			_axios2.default.get('https://api.github.com/search/repositories?q=language:javascript&sort=stars&order=desc&page=1&per_page=50').then(function (response) {
	...
	undefined.$http.post('url', data, options).then(function (res) {
		console.log(res);
	}).catch(function (err) {
		console.log(err);
	});
